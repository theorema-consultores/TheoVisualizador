...
test('stores a ZIP and navigates to the root shell without protocol in the target URL', async () => {
  ...
  assert.equal(result.dashboard.page, 'dashboards/balancete-receita/');
