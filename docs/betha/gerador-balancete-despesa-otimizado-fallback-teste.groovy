 ...
 *
 * Usa diretamente a fonte mensal anualizada, que foi mais rápida no teste
 * anterior. A ausência de visao neste contexto é esperada neste experimento.
 */
...
final def VERSAO_GERADOR = "2026-09-14-05-otimizado-fallback-teste"
...
def resultados = exercicios.collect { ano ->
  ...
  [
    ...
    relatorio: [
      nome: "Balancete da despesa - teste fallback otimizado",
      exercicio: ano,
...
def arquivoResultado = Arquivo.novo(
  "balancete-despesa-otimizado-fallback-teste.json",
  "json"
)
arquivoResultado.escreverObjeto(dadosJson)

variaveis.visao.adicionarRelatorio(
  id: "balancete-despesa-otimizado-fallback-teste",
  version: "1.0.0",
  nome: "balancete-despesa-otimizado-fallback-teste.json",
